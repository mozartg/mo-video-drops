...
|---|---|---|---|---|
| #2 | `agent/verified-drive-out-media-batch` | Open, draft, mergeable, 7 commits, 55 files | MERGE candidate after human review; keep draft now | Local tests, receipts, and the long-form artifact are verified, but GitHub reports no checks and the public deployment is not verified. |
